...
while True:
  ...
  client.write_register(2, 0)  # Bottle is not under the nozzle (Desligar o sensor de presença da garrafa)
  client.write_register(3, 1)  # Start the roller (Ligar o motor da esteira)
